...
void lba_init();
enum drives { first_drive, second_drive };
enum ide_controller { primary_controller, secondary_controller };
...
extern void write_ata_primary_controller_first_drive(uint64_t sector, uint8_t count,
                                                     uint8_t* buffer);
extern void write_ata_primary_controller_second_drive(uint64_t sector, uint8_t count,
                                                      uint8_t* buffer);
extern void write_ata_secondary_controller_first_drive(uint64_t sector, uint8_t count,
                                                       uint8_t* buffer);
extern void write_ata_secondary_controller_second_drive(uint64_t sector, uint8_t count,
                                                        uint8_t* buffer);
